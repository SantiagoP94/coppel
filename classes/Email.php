...
class Email {
    ...
    public function enviarConfirmacion() {
        ...
        $mail->SMTPAuth = true;
        $mail->Port = 2525;
        $mail->Username = '6f10ab33907c99';
        $mail->Password = '0152b9b277b657';
        ...
        $contenido = '<html>';
        $contenido .= "<p><strong>Hola " . $this->nombre . "</strong> Has Creado tu cuenta en Corrales Terreno, solo debes confirmarla en el siguiente enlace</p>";
